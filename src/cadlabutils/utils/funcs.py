...
"""
System memory and runtime time profiling
===============================================================================
"""
def clear_terminal():
...
def profile_func(
    ...
    t0 = time.time()
    output = func(**kwargs)
    h, m, s = elapsed_time(time.time() - t0)
...
"""
I/O functionality and aesthetics
===============================================================================
"""
def pbar(
        item,
    ...
    Args:
        ...
        tabs (int):
            ...
            Defaults to 1.
    """
    desc = desc.ljust(10, " ")[:10]
    return rp.track(item, description=f"{'    ' * tabs}{desc}")
