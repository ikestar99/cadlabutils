...
#             bases (int):
#                 Number of output bases predicted by model.
#             gpu (int, optional):
...
#             (bases, bases), dtype=torch.double, device=self.device,
#             requires_grad=False)
#
#     def __getattr__(
#             self,
